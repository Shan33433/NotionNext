...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '这是一个存在于网络中的,全面提升自我，放松身心的隐世修道所',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '茴香豆知识库', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '知识库创作者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://huixiangdou.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '茴香豆知识库', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://b23.tv/BmPUqjC', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || 'https://www.xiaohongshu.com/user/profile/6002bf89000000000101e44f?xhsshare=CopyLink&appuid=6002bf89000000000101e44f&apptime=1721214339&share_id=73baf6b138e34846a6f67aa99844f1a6', // 小红书主页
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'Huixiangdou', // 你的Github仓库名，例如 'NotionNext'
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || '', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'Shan', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个有我们打造的多元化知识库', // 站点描述，被notion中的页面描述覆盖
