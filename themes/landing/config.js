const CONFIG = {
  ...
  LANDING_HERO_P_1: '打破信息茧房，提升自我！',
  LANDING_HERO_BUTTON_1_TEXT: '开始体验',
  LANDING_HERO_BUTTON_1_LINK: 'https://www.huixiangdou.top/',
  LANDING_HERO_BUTTON_2_TEXT: '了解更多',
  LANDING_HERO_BUTTON_2_LINK: 'https://www.huixiangdou.top/',
  LANDING_HERO_VIDEO_IMAGE: '/f25c4b7531170149b1fb1ea34e4de4da.png',
  ...
  LANDING_FEATURES_CARD_1_TITLE: '打破信息茧房',
  LANDING_FEATURES_CARD_1_P: '跳出短视频的掌控，挣脱大数据的枷锁',
  LANDING_FEATURES_CARD_2_TITLE: '多元化的知识信息',
  LANDING_FEATURES_CARD_2_P: '商业大佬的思维认知，古今中外的知识结晶',
  LANDING_FEATURES_CARD_3_TITLE: '人性化的定制工具',
  LANDING_FEATURES_CARD_3_P: '多款工具网站供您挑选，可以获取各种不同风格和作用的网站和或软件，更多的内容正在陆续加入中。',
  ...
  LANDING_FEATURES_BLOCK_6_TITLE: '开始提升自己吧',
